...
st.markdown('<div style="text-align:left; font-size:14px;font-family: Oswald;color:#e65100"><b>'+datetime.now(argentina).strftime('%A %d-%m-%Y %H:%M')+'</b></div><br>', unsafe_allow_html=True)
